...
public class PacketDataFactory {
	...
	public static byte[] createMessagePacket(byte msgtype, String str) {
		...
		b[OffsetConstants.PACKET_TYPE_OFFSET] = ServerPacketType.MESSAGE;
	...
	public static byte[] createInitializer(long worldseed, int id, String name) {
		...
		b[OffsetConstants.PACKET_TYPE_OFFSET] = ServerPacketType.INITIALIZER;
		b[OffsetConstants.SEQUENCE_NUMBER_OFFSET] = 0;
	...
	public static byte[] createPlayerJoined(int id, String name) {
		...
		b[OffsetConstants.PACKET_TYPE_OFFSET] = ServerPacketType.PLAYER_JOINED;
		b[OffsetConstants.SEQUENCE_NUMBER_OFFSET] = 0;
	...
	public static byte[] createPlayerLeft(int id) {
		...
		b[OffsetConstants.PACKET_TYPE_OFFSET] = ServerPacketType.PLAYER_LEFT;
		b[OffsetConstants.SEQUENCE_NUMBER_OFFSET] = 0;
	...
	public static byte[] createPosition(long time, Ship s) {
		...
		b[OffsetConstants.PACKET_TYPE_OFFSET] = ServerPacketType.PLAYER_POSITION;
		b[OffsetConstants.SEQUENCE_NUMBER_OFFSET] = 0;
