 ...
 *
 */
public class RotateDownAction extends KeyInputAction {
    ...
    private Vector3f rotAxis = new Vector3f(0,0,1); //we are using +Z as our up
     ...
     */
    public RotateDownAction(Ship Ship) {
        this.node = Ship;
    }
